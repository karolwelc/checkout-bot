...
import (
	...
	utls "github.com/ProjektPLTS/pkg/tls/utls"
)
...
var (
	// Chrome h2 fingerprint: 1:65536,3:1000,4:6291456,6:262144|15663105|0|m,a,s,p
	// 7ad845f20fc17cc8088a0d9312b17da1
	// Chrome tls fingerprint: 771,4865-4866-4867-49195-49199-49196-49200-52393-52392-49171-49172-156-157-47-53,0-23-65281-10-11-35-16-5-13-18-51-45-43-27-17513,29-23-24,0
	...
	// Android h2 fingerprint: 2:0,4:4194304,6:10485760|1073741824|0|m,s,p,a
	// 11466fb3850ac1c0fc1d41c5a7914d69
	// Android tls fingerprint: 771,49195-49196-52393-49199-49200-52392-49171-49172-156-157-47-53,65281-0-23-35-13-5-16-11-10,29-23-24,0
	// 6f5e62edfa5933b1332ddf8b9fb3ef9d
	androidMimic = Settings{
		H2HeaderOrder: []string{
			":method",
			":scheme",
			":path",
		...
		H2Settings: []H2Setting{
			...
			{ID: H2SettingInitialWindowSize, Val: 4194304},
			{ID: H2SettingMaxHeaderListSize, Val: 10485760},
		},
		H2StreamFlow: 1073741824,
		ClientHello: func() *utls.ClientHelloSpec {
			return &utls.ClientHelloSpec{
				CipherSuites: []uint16{
					utls.TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,
